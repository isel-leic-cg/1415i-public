...
public class RotatingSquare {
	...
	public RotatingSquare(float cx, float cy, float sz, float[] color,
	...
	public void display(GL2 gl) {
		// Save state of MODEL_VIEW matrix
		gl.glPushMatrix();
		{
		...
		// Restore state of MODEL_VIEW matrix
		gl.glPopMatrix();
	}
